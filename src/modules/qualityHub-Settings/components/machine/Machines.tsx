...
const Machines = () => {
  const [showMachineForm, setShowMachineForm] = useState<{ show: boolean; formType: 'ADD' | 'EDIT' }>({
    show: false,
    formType: 'ADD',
  });
      ...
      <Grid item>
        ...
        {showMachineForm.show && (
          <MachineForm
            ...
            formType={showMachineForm.formType}
            submitHandler={handleMachineFormSubmit}
            displayMachineForm={setShowMachineForm}
          />
        )}
      </Grid>
      <Grid item>
        {machineResults.data && (
          <MachineList machines={machines} selectMachine={setSelectedMachine} displayMachineForm={setShowMachineForm} />
        )}
      </Grid>
    </Grid>
  );

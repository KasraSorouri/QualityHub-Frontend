...
const ClassCodes = () => {
  ...
  const [ showClassCodeForm, setShowClassCodeForm ] = useState<{ show: boolean, formType: 'ADD' | 'EDIT' }>({ show: false, formType: 'ADD' });
  ...
  return(
    <Grid container direction={'column'} spacing={2}>
      <Grid item>
        ...
        { showClassCodeForm.show && <ClassCodeForm classCodeData={selectedClassCode} formType={showClassCodeForm.formType} submitHandler={handleClassCodeFormSubmit} displayClassCodeForm={setShowClassCodeForm} />}
      </Grid>
      <Grid item>
        { classCodeResults.data && <ClassCodeList classCodes={classCodes} selectClassCode={setSelectedClassCode} displayClassCodeForm={setShowClassCodeForm}/>}
      </Grid>
    </Grid>
  );
};
